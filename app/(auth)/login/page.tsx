    ...
    <div className="q-page" style={{ justifyContent: 'center', minHeight: '100svh' }}>
      <div style={{ padding: '0 24px', width: '100%', maxWidth: 440, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <div style={{ fontSize: 14, color: 'var(--text3)', marginTop: 4 }}>Sign in to your account</div>
        </div>
        ...
        <div className="q-card" style={{ padding: 24 }}>
          ...
          <div className="q-form-group">
            ...
            <input className="q-input" type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="••••••••" onKeyDown={e => e.key === 'Enter' && handleLogin()}/>
          </div>

          <button onClick={handleLogin} disabled={loading || !email || !password} className="q-btn-primary" style={{ marginBottom: 16 }}>
          ...
          <div style={{ textAlign: 'center', fontSize: 14, color: 'var(--text3)' }}>
            No account?{' '}
            <Link href="/signup" style={{ color: 'var(--purple)', fontWeight: 700, textDecoration: 'none' }}>Sign up</Link>
          </div>
        </div>
      </div>
    </div>
